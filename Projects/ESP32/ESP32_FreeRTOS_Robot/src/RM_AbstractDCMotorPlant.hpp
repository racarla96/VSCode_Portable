/**
 * @file RM_AbstractDCMotorPlant.hpp
...
#include <RM_AbstractDCMotorDriver.hpp>
...
class AbstractDCMotorPlant {
    public:
         ...
         */
        AbstractDCMotorPlant(AbstractDCMotorDriver * drv, AbstractDCMotorPosSensor * sensor, float gain, float max_voltage, float min_voltage) 
            {_drv = drv; _sensor = sensor; _gain = gain; _max_voltage = max_voltage; _min_voltage = min_voltage;}
        ...
        virtual float getPosition() {return _sensor->getPosition();}
    ...
    protected:
        ...
        AbstractDCMotorPosSensor * _sensor;
