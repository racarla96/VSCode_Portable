...
#define schedUSE_TIMING_ERROR_DETECTION_EXECUTION_TIME 1
	...
	#define schedYIELD_FROM_ISR( xSwitchingRequired ) portYIELD_FROM_ISR( xSwitchingRequired )
...
/* Mutex needed for SMP implementation to protect shared structure */
static portMUX_TYPE ESFree_schedulerMutex = portMUX_INITIALIZER_UNLOCKED;
